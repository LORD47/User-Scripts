...
// @downloadURL   https://github.com/LORD47/User-Scripts/blob/master/Kat%20URL%20decoder.user.js
...
{    //https://kat.cr/confirm/url/aHR0cDovL2ltZ2NsaWNrLm5ldC81eXRqNmMyaGxmYW0vdmxjc25hcC0yMDE1LTA2LTExLTE2aDQ0bTU1czMzLnBuZy5odG1s/
...
(function () {
    ...
    $j(document).ready(function(){
        ...
        $j('a[href^="/confirm/url/"]').each(function(){ replaceURl( $j(this) ); });
